...
class Config(object):
    ...
    API_HASH  = os.environ.get("API_HASH", "d538c2e1a687d414f5c3dce7bf4a743c hash") # ⚠️ Required
    ...
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "videostonystack")) # ⚠️ Required
